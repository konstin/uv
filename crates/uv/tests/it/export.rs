...
async fn requirements_txt_https_credentials() -> Result<()> {
    ...
    pyproject_toml.write_str(&formatdoc! {r#"
        ...
        version = "0.1.0"
        requires-python = ">=3.12"
        dependencies = ["iniconfig @ {wheel_url}"]
    "#})?;

    context.lock().assert().success();

    // The credentials are for a direct URL, and are included in the export
    uv_snapshot!(filters, context.export(), @r"
    success: true
    exit_code: 0
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    #    uv export --cache-dir [CACHE_DIR]
    iniconfig @ http://public:heron@[SERVER]/files/packages/ef/a6/62565a6e1cf69e10f5727360368e451d4b7f58beeac6173dc9db836a5b46/iniconfig-2.0.0-py3-none-any.whl \
        --hash=sha256:b6a85871a79d2e3b22d2d1b94ac2824226a63c6b741c88f7ae975f18b6778374
        # via project
...
async fn pep_751_https_credentials() -> Result<()> {
    ...
    // The credentials are for a direct URL, and are included in the export
    uv_snapshot!(filters, context.export().arg("--format").arg("pylock.toml"), @r#"
    success: true
    exit_code: 0
    ----- stdout -----
    # This file was autogenerated by uv via the following command:
    ...
    name = "iniconfig"
    version = "2.0.0"
    archive = { url = "http://public:heron@[SERVER]/files/packages/ef/a6/62565a6e1cf69e10f5727360368e451d4b7f58beeac6173dc9db836a5b46/iniconfig-2.0.0-py3-none-any.whl", hashes = { sha256 = "b6a85871a79d2e3b22d2d1b94ac2824226a63c6b741c88f7ae975f18b6778374" } }
